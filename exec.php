...
<?php
// Connect to Database
$conn = pg_connect("dbname=quickscript");
...
function check_username($username)
{
	...
	// Create Query
	$query = "SELECT * FROM quickscript.user_info 
				WHERE username 
				LIKE $1";
...
function create_user($username, $password)
{
	...
	$query = "INSERT INTO quickscript.user_info (username) 
				VALUES ($1)";
	...
	$query = "INSERT INTO quickscript.authentication (username, password_hash,salt) 
				VALUES ($1, $2, $3)";
...
function check_login($username, $password)
{
	...
	$query = "SELECT salt, password_hash 
				FROM quickscript.authentication 
				WHERE username 
				LIKE $1";
...
function log_data($username, $ip, $action)
{
	...
	// Query Database
	$query = "INSERT INTO quickscript.log (username, ip_address, action) 
				VALUES ($1, $2, $3)";
